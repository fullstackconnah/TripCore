    ...
    public static async Task SeedAsync(TripCoreDbContext context, CancellationToken ct = default)
    {
        ...
        if (!hasUsers)
        {
            ...
            var users = new List<User>
            {
                ...
                new() { Id = Guid.Parse("b2000000-0000-0000-0000-000000000001"), Username = "rachel.thompson", Email = "rachel.thompson@tripcore.com.au", PasswordHash = BCryptHash("Staff123!"), FirstName = "Rachel", LastName = "Thompson", Role = UserRole.Coordinator, StaffId = existingStaff.Count > 4 ? existingStaff[4].Id : null },
                new() { Id = Guid.Parse("b2000000-0000-0000-0000-000000000002"), Username = "emily.nguyen", Email = "emily.nguyen@tripcore.com.au", PasswordHash = BCryptHash("Staff123!"), FirstName = "Emily", LastName = "Nguyen", Role = UserRole.SupportWorker, StaffId = existingStaff.Count > 2 ? existingStaff[2].Id : null },
                new() { Id = Guid.Parse("b2000000-0000-0000-0000-000000000003"), Username = "daniel.williams", Email = "daniel.williams@tripcore.com.au", PasswordHash = BCryptHash("Staff123!"), FirstName = "Daniel", LastName = "Williams", Role = UserRole.SupportWorker, StaffId = existingStaff.Count > 3 ? existingStaff[3].Id : null },
                new() { Id = Guid.Parse("b2000000-0000-0000-0000-000000000004"), Username = "coordinator.read", Email = "readonly@tripcore.com.au", PasswordHash = BCryptHash("Read123!"), FirstName = "Read", LastName = "Only", Role = UserRole.ReadOnly },
            };
        ...
        var staff = new List<Staff>
        {
            ...
            // New staff
            new() { Id = Guid.Parse("a2000000-0000-0000-0000-000000000001"), FirstName = "Marcus", LastName = "Papadopoulos", Role = StaffRole.SeniorSupportWorker, Email = "marcus.papadopoulos@tripcore.com.au", Mobile = "0412345006", Region = "Brisbane Metro", IsDriverEligible = true, IsFirstAidQualified = true, IsMedicationCompetent = true, IsManualHandlingCompetent = true, IsOvernightEligible = true },
            new() { Id = Guid.Parse("a2000000-0000-0000-0000-000000000002"), FirstName = "Priya", LastName = "Sharma", Role = StaffRole.SupportWorker, Email = "priya.sharma@tripcore.com.au", Mobile = "0412345007", Region = "Melbourne Metro", IsDriverEligible = false, IsFirstAidQualified = true, IsMedicationCompetent = true, IsManualHandlingCompetent = true, IsOvernightEligible = true },
            new() { Id = Guid.Parse("a2000000-0000-0000-0000-000000000003"), FirstName = "Lachlan", LastName = "Robertson", Role = StaffRole.SupportWorker, Email = "lachlan.robertson@tripcore.com.au", Mobile = "0412345008", Region = "South East QLD", IsDriverEligible = true, IsFirstAidQualified = false, IsMedicationCompetent = false, IsManualHandlingCompetent = true, IsOvernightEligible = false, Notes = "Currently completing First Aid renewal." },
            new() { Id = Guid.Parse("a2000000-0000-0000-0000-000000000004"), FirstName = "Jade", LastName = "Watkins", Role = StaffRole.Coordinator, Email = "jade.watkins@tripcore.com.au", Mobile = "0412345009", Region = "Greater Sydney", IsDriverEligible = true, IsFirstAidQualified = true, IsMedicationCompetent = true, IsManualHandlingCompetent = true, IsOvernightEligible = true },
            new() { Id = Guid.Parse("a2000000-0000-0000-0000-000000000005"), FirstName = "Brendan", LastName = "Nguyen", Role = StaffRole.TeamLeader, Email = "brendan.nguyen@tripcore.com.au", Mobile = "0412345010", Region = "Brisbane Metro", IsDriverEligible = true, IsFirstAidQualified = true, IsMedicationCompetent = true, IsManualHandlingCompetent = true, IsOvernightEligible = true },
        };
        ...
        var properties = new List<AccommodationProperty>
        {
            ...
            // New properties
            new() { Id = Guid.Parse("f3000000-0000-0000-0000-000000000001"), PropertyName = "Kangaroo Point Accessible Units", ProviderOwner = "Brisbane River Stays", Location = "Brisbane, QLD", Region = "Brisbane Metro", Address = "42 River Terrace", Suburb = "Kangaroo Point", State = "QLD", Postcode = "4169", ContactPerson = "Wayne Burns", Email = "stays@brisbaneriverstays.com.au", Phone = "07 3391 2200", IsFullyModified = true, IsWheelchairAccessible = true, BedroomCount = 4, BedCount = 7, MaxCapacity = 9, BeddingConfiguration = "2x king (adjustable), 3x single, 1x double", HoistBathroomNotes = "Mobile hoist available. Roll-in shower in master. Grab rails throughout.", AccessibilityNotes = "Level entry from car park. Wide doorways. Lift to all floors. City views." },
            new() { Id = Guid.Parse("f3000000-0000-0000-0000-000000000002"), PropertyName = "Cairns Esplanade Accessible Apartments", ProviderOwner = "North QLD Accessible Travel", Location = "Cairns, QLD", Region = "North QLD", Address = "212 The Esplanade", Suburb = "Cairns", State = "QLD", Postcode = "4870", ContactPerson = "Trish Lawson", Email = "bookings@nqat.com.au", Phone = "07 4031 8800", IsFullyModified = true, IsWheelchairAccessible = true, BedroomCount = 5, BedCount = 8, MaxCapacity = 10, BeddingConfiguration = "2x king (adjustable), 2x queen, 2x single", HoistBathroomNotes = "Ceiling hoist in master. Two roll-in showers. Shower commode available.", AccessibilityNotes = "Ground floor. 50m to Esplanade boardwalk. Pool with hoist. Parking onsite." },
        };
        ...
        var vehicles = new List<Vehicle>
        {
            ...
            // New vehicles
            new() { Id = Guid.Parse("f4000000-0000-0000-0000-000000000001"), VehicleName = "Toyota HiAce Accessible Van 2", Registration = "789DEF", VehicleType = VehicleType.AccessibleVan, TotalSeats = 9, WheelchairPositions = 2, RampHoistDetails = "Hydraulic side ramp, 350kg capacity. 2x Q-straint tie-down positions.", DriverRequirements = "LR licence. Manual handling cert for ramp operation.", IsInternal = true, ServiceDueDate = DateOnly.FromDateTime(DateTime.UtcNow.AddMonths(6)), RegistrationDueDate = DateOnly.FromDateTime(DateTime.UtcNow.AddMonths(14)), Notes = "Newer model. Air suspension for smoother ride." },
            new() { Id = Guid.Parse("f4000000-0000-0000-0000-000000000002"), VehicleName = "Toyota Coaster Minibus", Registration = "321GHI", VehicleType = VehicleType.MiniBus, TotalSeats = 21, WheelchairPositions = 0, DriverRequirements = "MR licence required.", IsInternal = false, ServiceDueDate = DateOnly.FromDateTime(DateTime.UtcNow.AddMonths(1)), RegistrationDueDate = DateOnly.FromDateTime(DateTime.UtcNow.AddMonths(5)), Notes = "Hire vehicle. Contact Gold Coast Charter Bus for booking." },
        };
        ...
        var trips = new List<TripInstance>
        {
            ...
            // New 5
            new() { Id = Guid.Parse("09000000-0000-0000-0000-000000000001"), TripName = "Cairns Tropical Getaway — July 2026", TripCode = "CAIRNS-2026J", EventTemplateId = templates[3].Id, Destination = "Cairns, QLD", Region = "North QLD", StartDate = today.AddDays(150), DurationDays = 7, Status = TripStatus.Planning, LeadCoordinatorId = staff[9].Id, MinParticipants = 4, MaxParticipants = 8, RequiredWheelchairCapacity = 2, RequiredBeds = 8, RequiredBedrooms = 5, MinStaffRequired = 3, Notes = "First Cairns trip. Reef and rainforest focus. Confirm wheelchair access for reef pontoon." },
            new() { Id = Guid.Parse("09000000-0000-0000-0000-000000000002"), TripName = "Gold Coast Beach Break — Winter 2026", TripCode = "GCBB-2026W", EventTemplateId = templates[0].Id, Destination = "Gold Coast, QLD", Region = "South East QLD", StartDate = today.AddDays(200), DurationDays = 5, Status = TripStatus.OpenForBookings, LeadCoordinatorId = staff[0].Id, MinParticipants = 4, MaxParticipants = 7, RequiredWheelchairCapacity = 2, RequiredBeds = 7, RequiredBedrooms = 4, MinStaffRequired = 3, Notes = "Winter break — mild weather ideal for outdoor activities." },
            new() { Id = Guid.Parse("09000000-0000-0000-0000-000000000003"), TripName = "Blue Mountains Adventure — Autumn 2026", TripCode = "BMA-2026A", EventTemplateId = templates[1].Id, Destination = "Katoomba, NSW", Region = "Greater Sydney", StartDate = today.AddDays(-90), DurationDays = 4, Status = TripStatus.Completed, LeadCoordinatorId = staff[3].Id, MaxParticipants = 5, MinStaffRequired = 2, Notes = "Autumn colours trip. Completed successfully." },
            new() { Id = Guid.Parse("09000000-0000-0000-0000-000000000004"), TripName = "Melbourne Arts Weekend — March 2026", TripCode = "MAW-2026M", EventTemplateId = templates[2].Id, Destination = "Melbourne, VIC", Region = "Melbourne Metro", StartDate = today.AddDays(-1), DurationDays = 3, Status = TripStatus.InProgress, LeadCoordinatorId = staff[4].Id, MinParticipants = 2, MaxParticipants = 5, RequiredWheelchairCapacity = 1, RequiredBeds = 5, RequiredBedrooms = 3, MinStaffRequired = 2, Notes = "In progress. Day 2 of 3." },
            new() { Id = Guid.Parse("09000000-0000-0000-0000-000000000005"), TripName = "Brisbane Day Trips — April 2026", TripCode = "BDT-2026", Destination = "Brisbane, QLD", Region = "Brisbane Metro", StartDate = today.AddDays(30), DurationDays = 2, Status = TripStatus.Cancelled, LeadCoordinatorId = staff[5].Id, Notes = "Cancelled — lead coordinator unavailable. Rescheduling for later in year." },
        };
