        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {trips.map((t: any) => (
            <Link key={t.id} to={`/trips/${t.id}`}
              className="bg-white rounded-2xl p-5 hover:shadow-[0_24px_32px_-12px_rgba(27,28,26,0.08)] transition-all group">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h3 className="font-semibold group-hover:text-[#396200] transition-colors">{t.tripName}</h3>
